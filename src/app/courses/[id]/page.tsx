...
function CourseDetail({ params }: CourseDetailProps) {
  ...
  function getUnitDescription(unitNumber: number): string {
    ...
    return (
      descriptions[unitNumber - 1] || "Advanced IELTS preparation content"
    );
  }
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-primary text-primary-foreground">
        <div className="container mx-auto px-4 py-8">
          <Link href="/" className="inline-flex items-center gap-2 text-primary-foreground/80 hover:text-primary-foreground mb-6">
